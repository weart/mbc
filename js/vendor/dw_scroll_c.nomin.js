...
/*
    RedRudeBoy
    @License: privative, pending to resolve, the website was down for a long time
    @Added: dw_scrollObj.minX feature
*/
...
dw_scrollObj.minX = 1024; //min scroll width
...
/* License method commented bypass, pending to pay, the website was down for a long time.
Alert very clever! Now I understand why in my local I never see the popup!! Nice!
var dw_Inf={};
...
if(!(dw_Inf.gw1==''||dw_Inf.gw1=='127.0.0.1'||dw_Inf.gw1.indexOf('localhost')!=-1||dw_Inf.gw2.indexOf('dyn-web.com')!=-1))alert(dw_Inf.mg);dw_scrollObj.scrdy=true;
